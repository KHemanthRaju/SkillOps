...
function SpeechRecognitionComponent() {
  ...
  }, [currentLanguage, setTranscript, setIsListening]);
  ...
  // Make sure we have a valid language key (default to 'EN' if not)
  const validLanguage = TEXT[currentLanguage] ? currentLanguage : 'EN';
  
  return (
    <Tooltip title={isListening ? TEXT[validLanguage].SPEECH_RECOGNITION_STOP : TEXT[validLanguage].SPEECH_RECOGNITION_START}>
