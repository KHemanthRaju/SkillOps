...
import { ModeProvider } from './utilities/ModeContext';
import { AgentProvider } from './utilities/AgentContext';
import { ProfileProvider } from './utilities/ProfileContext';
import { ThemeProvider as CustomThemeProvider, useTheme } from './utilities/ThemeContext';
  ...
  return (
    <Grid container direction="column" justifyContent="center" alignItems="stretch" className="appHeight100 appHideScroll">
      ...
      <Grid item container direction="row" justifyContent="flex-start" alignItems="stretch" className="appFixedHeight100">
        <Grid item xs={showLeftNav ? 3 : 0.5} sx={{ backgroundColor: isSparkyTheme ? '#8C1D40' : '#2196F3' }}>
